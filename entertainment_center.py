...
# define and initialize values for my favorite movies.
# each args are title, year, storyline, starring,
# poster_image_url, rating, trailer_youtube_url

# constantine
constantine = media.Movie("Constantine",
                          "2005",
                          "Supernatural detective John Constantine helps "
                          "a policewoman prove her sister's death was not"
                          "a suicide, but something more.",
                          "Keanu Reeves, Rachel Weisz, Djimon Hounsou",
                          "https://upload.wikimedia.org/wikipedia/en"
                          "/2/2b/Constantine_poster.jpg",
                          "9.5",
...
avengers = media.Movie("The Avengers",
                       ...
                       "to fight as a team if they are to "
                       "stop the mischievous Loki "
...
captain_america = media.Movie("Captain America: Civil War",
                              ...
                              "M/MV5BMjQ0MTgyNjAxMV5BMl5Ban"
                              "BnXkFtZTgwNjUzMDkyODE@"
                              "._V1_SY1000_CR0,0,674,1000_AL_.jpg",
                              "8.2",
...
thor = media.Movie("Thor",
                   "2011",
                   "The powerful but arrogant god Thor is cast out of "
                   "Asgard to live amongst humans in Midgard "
                   "(Earth), where he soon becomes "
                   "one of their finest defenders.",
                   "Chris Hemsworth, Anthony Hopkins, Natalie Portman",
                   "https://images-na.ssl-images-amazon.com/images/"
                   "M/MV5BOGE4NzU1YTAtNzA3Mi00ZTA2LTg2YmYtMDJmMThiM"
                   "jlkYjg2XkEyXkFqcGdeQXVyNTgzMDMzMTg@."
                   "_V1_SY1000_CR0,0,674,1000_AL_.jpg",
                   "7.8",
...
matrix = media.Movie("Matrix",
                     ...
                     "https://images-na.ssl-images-amazon.com/images/M/MV5BNz"
                     "QzOTk3OTAtNDQ0Zi00ZTVkLWI0MTEtMDllZjNkYzNjNTc4L2ltYWdl"
                     "XkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SY1000_CR0,"
                     "0,665,1000_AL_.jpg",
                     "9.8",
...
dark_knight = media.Movie("The Dark Knight Rises",
                          ...
                          "Selina, is forced from his exile to save Gotham "
                          "City, now on the edge of total annihilation, "
                          "from the brutal guerrilla terrorist Bane.",
                          "Christian Bale, Tom Hardy, Anne Hathaway",
                          "https://images-na.ssl-images-amazon.com"
                          "/images/M/MV5BMTk4ODQzNDY3Ml5BMl5BanBnXk"
                          "FtZTcwODA0NTM4Nw@@._V1_.jpg",
                          "9.4",
                          "https://www.youtube.com/watch?v=g8evyE9TuYk")

# Store movies in the list
movies = [constantine, iron_man, thor, avengers, captain_america,
          inception, matrix, interstella, dark_knight]
